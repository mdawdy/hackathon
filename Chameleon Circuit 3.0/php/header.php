                    ...
                    <ul class="sf-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="home.php?sidebar">Sidebar</a></li>
                            </ul>
                        </li>
                        <li class="<?php if ($_GET['t']=='pages') echo "active" ?>">
                            <a href="pages.php?t=pages">
